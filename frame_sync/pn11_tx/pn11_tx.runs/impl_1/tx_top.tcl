...
namespace eval ::optrace {
  variable script "/home/plwalker/Preston-Walker_AMT_SQUAD/AMT_SQUAD/frame_sync/pn11_tx/pn11_tx.runs/impl_1/tx_top.tcl"
...
set_property TOP tx_top [current_fileset]
OPTRACE "read constraints: write_bitstream" START { }
OPTRACE "read constraints: write_bitstream" END { }
  set_property XPM_LIBRARIES XPM_CDC [current_project]
  catch { write_mem_info -force -no_partial_mmi tx_top.mmi }
...
OPTRACE "read constraints: write_bitstream_post" END { }
  catch {write_debug_probes -quiet -force tx_top}
  catch {file copy -force tx_top.ltx debug_nets.ltx}
